...
# End-to-end tool tests: Orchestrate CLI chat + Slack via gateway MCP.
#
# Prereqs:
#   - toolkit slack_wxo_gateway registered (CE or ngrok URL)
#   - .env with WXO_* + SLACK_*
#   - orchestrate env activated
# ---
set -euo pipefail
